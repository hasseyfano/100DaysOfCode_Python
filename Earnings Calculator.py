...
print("PLEASE CHOOSE BETWEEN THESE OPTIONS BELOW")
name=input("Please input employee name: ").strip().title()
hourlyWage=int(input("please input employee hourly wage: "))
weeklyHours=int(input("please input employee weekly hours: "))
totalEarnings=int(hourlyWage*weeklyHours)
print(f"{name} earned {totalEarnings} this week")
